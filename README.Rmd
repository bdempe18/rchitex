...
[![Codecov test coverage](https://codecov.io/gh/bdempe18/rchitex/branch/master/graph/badge.svg)](https://codecov.io/gh/bdempe18/rchitex?branch=master)
<!-- badges: end -->
...
You can install the released version of rchitex from [CRAN](https://CRAN.R-project.org) with:
